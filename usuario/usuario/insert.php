                ...
                <div>
                    <form action="doinsert.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" id="nombre" name="nombre" id="nombre" placeholder="Introduce el nombre"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="clave">Clave</label>
                            <input required type="text" class="form-control" id="clave" name="clave" id="clave" placeholder="Introduce la contraseña"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="fecha">Fecha Alta</label>
                            <input required type="text" class="form-control" id="fecha" name="fecha" id="fecha" placeholder="Introduce la fecha"></textarea>
                        </div>
