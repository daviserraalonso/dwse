    ...
    class Email {
      ...
      static function sendMail($to, $subject, $message, $alias='', $from='') {
          ...
          if(trim($to) !== '' && trim($subject) !== '') {
              ...
              $url = 'https://dwse-scorpions.c9users.io/practicaUsuarios/classes/izv/activacion/token.conf';
              $cliente->setAccessToken(file_get_contents($url));
      ...
      static function sendActivationP(Usuario $usuario) {
          $asunto = 'Correo de activación para los usuarios';
